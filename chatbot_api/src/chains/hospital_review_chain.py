...
review_human_template = HumanMessagePromptTemplate(prompt = PromptTemplate(input_variables = ["context"], template = "{question}"))

messages = [review_system_prompt, review_human_template]
